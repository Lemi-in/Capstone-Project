      ...
      <div className="w-full h-full">
        ...
        <div className="absolute w-full top-[20%] p-4 md:p-16">
          ...
          <div className="my-4">
            <button
              onClick={handleClick}
              className=" border bg-gray-300 hover:font-mono  text-black border-gray-300 py-2 px-5"
            >
              Play
            </button>
            <button className="border text-[#FFFDE3] border-gray-300 hover:bg-yellow-700 py-2 px-5 ml-4 ">
              Watch Later
            </button>
          </div>
